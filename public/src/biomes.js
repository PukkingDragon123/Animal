...
export const BIOMES = {
  forest: {
    ...
    props: [
      { build: 'tree', count: 26, scale: [1.0, 1.7] },
      { build: 'bush', count: 20, scale: [0.7, 1.2] },
      { build: 'log', count: 6, scale: [0.9, 1.3] },
      { build: 'flowerProp', count: 30, scale: [0.6, 1.0] },
    ],
    water: false,
  },
  meadow: {
    ...
    props: [
      { build: 'flowerProp', count: 60, scale: [0.6, 1.2] },
      { build: 'bush', count: 12, scale: [0.6, 1.0] },
      { build: 'tree', count: 6, scale: [0.9, 1.3] },
    ],
    water: false,
  },
  arctic: {
